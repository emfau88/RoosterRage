// The new production roosters are the default. Append ?roosterVisual=legacy
// to roll all of them back, or use ?aceVisual=legacy,
...
const versionFor = (id) => (
  globalVersion === 'legacy' || parameters.get(`${id}Visual`) === 'legacy'
    ? 'legacy'
    : 'next'
);
...
export const USE_NEXT_ARTILLERY_VISUAL = ARTILLERY_VISUAL_VERSION === 'next';
export const USE_NEXT_STORM_VISUAL = STORM_VISUAL_VERSION === 'next';
...
export const ARTILLERY_NEXT_WALK_FRAME_RATE = 4 * 1000 / 650;
export const ARTILLERY_NEXT_IDLE_FRAME_RATE = 8 * 1000 / 3200;
export const STORM_NEXT_WALK_FRAME_RATE = 4 * 1000 / 440;
