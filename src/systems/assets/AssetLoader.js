...
import roosterArtilleryWalkSheetUrl from '../../assets/characters/rooster-artillery-walk-v2.webp';
import roosterStormWalkSheetUrl from '../../assets/characters/rooster-storm-walk-v2.webp';
...
import arenaGroundOrchardUrl from '../../assets/map/arena-ground-orchard.webp';
import arenaGroundRoadUrl from '../../assets/map/arena-ground-road.webp';
import arenaFeedAlleyEdgeUrl from '../../assets/map/arena-feed-alley-edge.webp';
...
export function preloadGameAssets(scene) {
  ...
  scene.load.image('arena-ground-orchard', arenaGroundOrchardUrl);
  scene.load.image('arena-ground-road', arenaGroundRoadUrl);
  scene.load.image('arena-feed-alley-edge', arenaFeedAlleyEdgeUrl);
