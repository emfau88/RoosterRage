...
RUNTIME_IMAGES = (
    ...
    "projectiles/golden-egg-r2.png",
    "projectiles/golden-egg-r3.png",
    "projectiles/golden-egg-r4.png",
    "projectiles/molotov-egg.png",
    "projectiles/molotov-modular/molotov-egg-r1.png",
    "projectiles/molotov-modular/molotov-egg-r2.png",
    "projectiles/molotov-modular/molotov-egg-r3.png",
    "projectiles/molotov-modular/molotov-egg-r4.png",
    "projectiles/molotov-modular/molotov-egg-evo.png",
    "projectiles/rocket-egg.png",
    "projectiles/rocket-modular/rocket-egg-r1.png",
    "projectiles/rocket-modular/rocket-egg-r2.png",
    "projectiles/rocket-modular/rocket-egg-r3.png",
    "projectiles/rocket-modular/rocket-egg-r4.png",
    "projectiles/rocket-modular/rocket-egg-evo.png",
    ...
    "map/coop-square-hay-stack.png",
    "map/previews/arena-preview-open-yard.png",
    "map/previews/arena-preview-vertical-run.png",
    "map/previews/arena-preview-square-coop.png",
    "map/posters/arena-poster-open-yard.png",
    "map/posters/arena-poster-vertical-run.png",
    "map/posters/arena-poster-square-coop.png",
    ...
    "fx/molotov-modular/molotov-ground-r1.png",
    "fx/molotov-modular/molotov-ground-r2.png",
    "fx/molotov-modular/molotov-ground-r3.png",
    "fx/molotov-modular/molotov-ground-r4.png",
    "fx/molotov-modular/molotov-ground-evo.png",
    "fx/molotov-modular/molotov-flame-small.png",
    "fx/molotov-modular/molotov-flame-medium.png",
    "fx/molotov-modular/molotov-flame-large.png",
    "fx/molotov-modular/molotov-embers.png",
    "fx/molotov-modular/molotov-ignition.png",
    "fx/molotov-modular/molotov-smoke.png",
    "fx/rocket-modular/rocket-impact-r1.png",
    "fx/rocket-modular/rocket-impact-r2.png",
    "fx/rocket-modular/rocket-impact-r3.png",
    "fx/rocket-modular/rocket-impact-r4.png",
    "fx/rocket-modular/rocket-impact-evo.png",
    "fx/rocket-modular/rocket-exhaust.png",
...
RUNTIME_SIZES = {
    ...
    # The world pickup art needs enough source detail for the ribbon lettering,
    # while the emitted WebP remains small enough for the release budget.
    "ui/stickers/pickup-heal-sticker-v2.png": (256, 256),
    "ui/stickers/pickup-bomb-sticker-v2.png": (256, 256),
    "ui/stickers/pickup-magnet-sticker-v2.png": (256, 256),
    ...
    "projectiles/golden-egg-r2.png": (34, 34),
    "projectiles/golden-egg-r3.png": (36, 36),
    "projectiles/golden-egg-r4.png": (40, 40),
    "projectiles/fire-egg-r3.png": (26, 26),
