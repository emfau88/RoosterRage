#!/usr/bin/env python3
"""Extract and normalize the modular Rocket Egg source atlases."""
...
FX_ROOT = PROJECT_ROOT / "art-source" / "fx" / "rocket-modular"
PROJECTILE_ROOT = PROJECT_ROOT / "art-source" / "projectiles" / "rocket-modular"
CELL_WIDTH = 512
CELL_HEIGHT = 512
...
def main() -> None:
    extract(
        PROJECTILE_ROOT / "rocket-projectile-atlas-chroma.png",
        PROJECTILE_ROOT,
        [
            ("rocket-egg-r1.png", (256, 160), (214, 112)),
            ("rocket-egg-r2.png", (256, 160), (226, 124)),
            ("rocket-egg-r3.png", (256, 160), (236, 140)),
            ("rocket-egg-r4.png", (256, 160), (238, 142)),
            ("rocket-egg-evo.png", (256, 160), (242, 148)),
        ],
    )
    extract(
        FX_ROOT / "rocket-impact-atlas-chroma.png",
        FX_ROOT,
        [
            ("rocket-impact-r1.png", (384, 256), (300, 160)),
            ("rocket-impact-r2.png", (384, 256), (328, 188)),
            ("rocket-impact-r3.png", (384, 256), (350, 208)),
            ("rocket-impact-r4.png", (384, 256), (362, 220)),
            ("rocket-impact-evo.png", (384, 256), (372, 232)),
            ("rocket-exhaust.png", (256, 128), (220, 88)),
        ],
    )
    exhaust_path = FX_ROOT / "rocket-exhaust.png"
    with Image.open(exhaust_path) as exhaust_source:
        exhaust = exhaust_source.convert("RGBA")
    exhaust.paste((0, 0, 0, 0), (0, 0, 96, exhaust.height))
    exhaust.save(exhaust_path, "PNG", optimize=True)
